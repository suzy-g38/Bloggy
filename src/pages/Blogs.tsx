...
import BlogsPageContainer from '../components/containers/BlogsContainer';
...
//   flex-direction: column;
//   color: ${props => props.theme.text};
//   min-height: 400px; /* Ensures a consistent, larger height */
// `;
...
// Define the Blog interface with TypeScript
interface Blog {
  id: string;
  title: string;
  content: string;
...
const BlogsPage: React.FC = () => {
  ...
  //   setPage(1);
  //   setHasMore(true);
  //   setInitialLoadComplete(false); // Reset initial load
  // }, [location.pathname]);
  ...
  //   if (initialLoadComplete) { // Only fetch more after initial load
...
//                  {location.pathname === '/dashboard' && blog.userId === userId && (
//                 <ActionButtons>
//                   <EditButton
//                     onClick={(e) => {
